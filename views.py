...
class view:
    ...
    def criaView(processa):
        if processa:
            cursor = conn.cursor()
            cursor.execute(view.vw_BuscaDiferencaSaldoFinalBancos_2023())
            cursor.execute(view.vw_BuscaDiferencaSaldoFinalBancosNaoCompoe_2023())
            cursor.execute(view.vw_BuscaDiferencaSaldoFinalBancosRestituiveis_2023())
            cursor.execute(view.vw_BuscaDiferencaValoresEmpenhados_2023())
            cursor.execute(view.vw_BuscaDiferencaValoresReceitas_2023())
            cursor.execute(view.vw_ConfereSaldoFinalBancos_2023())
            cursor.execute(view.vw_ConfereSaldoFinalBancosNaoCompoe_2023())
            cursor.execute(view.vw_ConfereSaldoFinalBancosRestituiveis_2023())
            cursor.execute(view.vw_ConfereValoresEmpenhados_2023())
            cursor.execute(view.vw_ConfereValoresReceitas_2023())
            cursor.execute(view.vw_RelatorioAnaliticoEmpenho_2023())
            cursor.execute(view.vw_RelatorioDiarioDespesa_2023())
            cursor.execute(view.vw_RelatorioMovimentosPorFonte_2023())
            conn.commit()
            cursor.close()