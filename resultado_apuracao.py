        ...
        if not st.session_state.cod_municipio_AM:
            ...
            if bancos:
                ...
                if bancos[0][0] == bancos[0][1]:
                    msg.success("Os valores dos arquivos CTB de Contas Bancárias do BALANCETE de Contas Bancárias são iguais")
                else:
                    msg.warning("Os valores dos arquivos CTB de Contas Bancárias e BALANCETE de Contas Bancárias são diferentes")
            ...
            if bancos:
                ...
                if bancos[0][0] == bancos[0][1]:
                    msg.success("Os valores dos arquivos CTB não Compõe Saldo de Caixa e Contas Bancárias não Compõe Saldo de Caixa do BALANCETE são iguais")
                else:
                    # Exibe os dados da diferença
                    msg.success("Os valores dos arquivos CTB não Compõe Saldo de Caixa e Contas Bancárias não Compõe Saldo de Caixa do BALANCETE são diferentes")
            ...
            if bancos:
                ...
                if bancos[0][0] == bancos[0][1]:
                    msg.success("Os valores dos arquivos CTB Valores Restituíveis e Contas Bancárias Valores Restituíveis do BALANCETE são iguais")
                else:
                    # Exibe os dados da diferença
                    msg.error("Os valores dos arquivos CTB Valores Restituíveis e Contas Bancárias Valores Restituíveis do BALANCETE são diferentes")
            ...
            if concilicacao_bancos:
                ...
                msg.warning("Não foram encontrados dados de Valores de Conciliação Bancária")
            ...
            if empenhos:
                ...
                if empenhos[0][0] == empenhos[0][1]:
                    msg.success("Os valores dos arquivos EMP e Contabilizados no Balancete são iguais")
                else:
                    msg.error("Os valores dos arquivos EMP e Contabilizados no Balancete são diferentes")
                ...
                msg.warning("Não foram encontrados dados para o usuário e ano fornecidos")
            ...
            if receitas:
                ...
                if receitas[0][0] == receitas[0][1]:
                    msg.success("Os valores dos arquivos REC e Contabilizados no Balancete são iguais")
                else:
                    msg.error("Os valores dos arquivos REC e Contabilizados no Balancete são diferentes")
